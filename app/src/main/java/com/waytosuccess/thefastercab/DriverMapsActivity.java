...
public class DriverMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (currentLocation != null) {
            LatLng driverCurLocation = new LatLng(currentLocation.getLatitude(), currentLocation.getLongitude());
            mMap.addMarker(new MarkerOptions().position(driverCurLocation).title("Driver is here"));
            mMap.moveCamera(CameraUpdateFactory.newLatLng(driverCurLocation));
        }
    }
    ...
    private void updateLocationUI() {
        if (currentLocation != null) {
            ...
            mMap.addMarker(new MarkerOptions().position(currentLarLng).title("Driver is here"));
